...
final class AnyOptionExtensionMethods[O <: Rep[_], P](val r: O) extends AnyVal {
  ...
  def fold[B, BP](
      ifEmpty: B
  )(f: P => B)(implicit shape: Shape[FlatShapeLevel, B, _, BP]): BP = {
  ...
  def getOrElse[M, P2 <: P](
      default: M
  )(implicit shape: Shape[FlatShapeLevel, M, _, P2], ol: OptionLift[P2, O]): P =
...
trait ExtensionMethodConversions {
  ...
  implicit def stringColumnExtensionMethods(
      c: Rep[String]
  ): StringColumnExtensionMethods[String] =
  ...
  implicit def booleanColumnExtensionMethods(
      c: Rep[Boolean]
  ): BooleanColumnExtensionMethods[Boolean] =
  ...
  implicit def anyColumnExtensionMethods[B1: BaseTypedType](
      c: Rep[B1]
  ): AnyExtensionMethods = new AnyExtensionMethods(c.toNode)
  ...
  implicit def singleColumnQueryExtensionMethods[B1: BaseTypedType, C[_]](
      q: Query[Rep[B1], _, C]
  ): SingleColumnQueryExtensionMethods[B1, B1, C] =
