...
sealed abstract class Query[+E, U, C[_]] extends QueryBase[C[U]] { self =>
  ...
  def joinLeft[E2, U2, D[_], O2](
      q2: Query[E2, _, D]
  )(implicit ol: OptionLift[E2, O2], sh: Shape[FlatShapeLevel, O2, U2, _]) = {
    val leftGen, rightGen = new AnonSymbol
    val aliased1          = shaped.encodeRef(Ref(leftGen))
    val aliased2 =
  ...
  def joinRight[E1 >: E, E2, U2, D[_], O1, U1](
      q2: Query[E2, U2, D]
  )(implicit ol: OptionLift[E1, O1], sh: Shape[FlatShapeLevel, O1, U1, _]) = {
    val leftGen, rightGen = new AnonSymbol
    val aliased1 =
...
object Query {
  ...
  def apply[E, U, R](
      value: E
  )(implicit unpack: Shape[_ <: FlatShapeLevel, E, U, R]): Query[R, U, Seq] = {
