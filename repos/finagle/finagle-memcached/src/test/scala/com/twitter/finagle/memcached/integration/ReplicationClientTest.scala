...
class ReplicationClientTest extends FunSuite with BeforeAndAfterEach {
  ...
  if (!sys.props.contains("SKIP_FLAKY")) // CSL-1712
    test("base replication client set & getOne") {
      ...
      assert(
        Await.result(
          replicatedClient.set("foo", Buf.Utf8("bar"))
  ...
  if (!sys.props.contains("SKIP_FLAKY")) // CSL-1712
    test("base replication client set & getAll") {
      ...
      assert(
        Await.result(
          replicatedClient.getAll("client2-only")
  ...
  if (!sys.props.contains("SKIP_FLAKY")) // CSL-1712
    test("base replication client delete") {
      ...
      assert(
        Await.result(
          replicatedClient.delete("empty-key")
  ...
  if (!sys.props.contains("SKIP_FLAKY")) // CSL-1712
    test("base replication client add & replace") {
      ...
      assert(
        Await.result(
          replicatedClient.add("foo", Buf.Utf8("bar"))
      ...
      assert(
        Await.result(
          replicatedClient.replace("foo", Buf.Utf8("baz"))
        ) == ConsistentReplication(true)
      )
      assert(
        Await.result(replicatedClient.getAll("foo")) == ConsistentReplication(
      ...
      assert(
        Await.result(
          replicatedClient.replace("no-such-key", Buf.Utf8("test"))
        ) == ConsistentReplication(false)
      )
      ...
      assert(
        Await.result(
          replicatedClient.add("client2-only", Buf.Utf8("test"))
        ) match {
          case InconsistentReplication(
  ...
  if (!sys.props.contains("SKIP_FLAKY")) // CSL-1712
    test("base replication client incr & decr") {
      ...
      assert(
        Await.result(
          replicatedClient.set("foo", Buf.Utf8("1"))
        ) == ConsistentReplication(())
      )
      assert(
        Await.result(replicatedClient.getAll("foo")) == ConsistentReplication(
  ...
  if (!sys.props.contains("SKIP_FLAKY")) // CSL-1731
    test("base replication client replica down") {
      ...
      assert(
        Await.result(
          replicatedClient.set("foo", Buf.Utf8("baz"))
        ) == ConsistentReplication(())
      )
    }
