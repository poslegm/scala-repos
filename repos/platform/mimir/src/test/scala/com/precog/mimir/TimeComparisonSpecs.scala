  ...
  "comparison of two DateTimes of value provenance" should {
    ...
    "compute lt resulting in true" in {
      val input = Join(
        ...
        parseDateTimeFuzzy("2011-06-03T04:12:33.323Z")
      )(line)
    ...
    "compute eq given equal times in different timezones" in {
      val input = Join(
        ...
        parseDateTimeFuzzy("2011-06-03T02:12:33.323Z")
      )(line)
    ...
    "produce correct results using lt" in {
      ...
      val input =
        Join(
          ...
          Const(CDate(new DateTime("2011-09-23T18:33:22.520")))(line)
        )(line)
