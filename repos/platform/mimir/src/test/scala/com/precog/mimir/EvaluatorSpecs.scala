  ...
  "evaluator" should {
    ...
    "MegaReduce of two tuples must return an array" in {
      ...
      val parent = dag.AbsoluteLoad(
        Const(CString("/hom/heightWeightAcrossSlices"))(line)
      )(line)
      ...
      val input =
        Join(
          ...
          Join(
            ...
            Cross(None),
            Const(CString("question"))(line),
            Const(CString("What is six times seven?"))(line)
          )(line),
          Join(
            WrapObject,
            Cross(None),
    ...
    "compute the iunion of two homogeneous sets (with relative load)" in {
      ...
      val input =
        IUI(
          ...
          dag.RelativeLoad(Const(CString("numbers3"))(line))(line)
        )(line)
    ...
    "filter homogeneous numeric set by binary operation" >> {
      "less-than" >> {
        ...
        val input = Filter(
          IdentitySort,
          numbers,
          Join(Lt, Cross(None), numbers, Const(CLong(13))(line))(line)
        )(line)
      ...
      "greater-than" >> {
        ...
        val input = Filter(
          IdentitySort,
          numbers,
          Join(Gt, Cross(None), numbers, Const(CLong(13))(line))(line)
        )(line)
    ...
    "correctly order a match following a cross within a new" in {
      ...
      val input = Join(
        ...
        IdentitySort,
        numbers,
        Join(Sub, Cross(None), numbers, dag.New(numbers)(line))(line)
      )(line)
            ...
            IntersectBucketSpec(
              dag.Extra(
                Join(
                  ...
                  Const(CString("/sign-up.html"))(line)
                )(line)
              ),
              UnfixedSolution(
                0,
    ...
    "evaluate a histogram function" in {
      ...
      val clicks = dag.AbsoluteLoad(
        dag.Morph1(expandGlob, Const(CString("/clicks"))(line))(line)
      )(line)
    ...
    "distinct homogenous set of numbers" in {
      ...
      val input = dag.Distinct(
        dag.AbsoluteLoad(Const(CString("/hom/numbers2"))(line))(line)
      )(line)
    ...
    "distinct heterogenous sets" in {
      ...
      val input = dag.Distinct(
        dag.AbsoluteLoad(Const(CString("/het/numbers2"))(line))(line)
      )(line)
    ...
    "correctly evaluate a constant object" in {
      ...
      val input = dag.Const(
        RObject("a" -> CNum(1), "b" -> CTrue, "c" -> CString("true"))
      )(line)
    ...
    "evaluate as a transspec a cond on a const left source" in {
      ...
      val source = dag.New(
        dag.Const(RObject("a" -> CBoolean(true), "c" -> CNum(2)))(line)
      )(line)
          ...
          Operate(
            ...
            Join(
              ...
              Join(
                ...
                dag.Const(CLong(1))(line)
              )(line),
              Join(
                WrapObject,
                Cross(None),
                dag.Const(CString("b"))(line),
                dag.Const(CLong(2))(line)
              )(line)
            )(line)
          )(line),
          Operate(
            ...
            Join(
              ...
              Join(
                ...
                Cross(None),
                dag.Const(CString("a"))(line),
                dag.Const(CLong(3))(line)
              )(line),
              Join(
                WrapObject,
                Cross(None),
                dag.Const(CString("b"))(line),
                dag.Const(CLong(4))(line)
              )(line)
            )(line)
          )(line)
        )(line)
