  ...
  "Period parsing" should {
    "parse period with all fields present" in {
      val input = Operate(
        ...
        Const(CString("P3Y6M4DT12H30M5S"))(line)
      )(line)
    ...
    "parse period with not all fields present" in {
      val input = Operate(
        BuiltInFunction1Op(ParsePeriod),
        Const(CString("P6M4DT30M5S"))(line)
      )(line)
    ...
    "compute correct range given multiple values" in {
      ...
      def createObject2(field: String, op1: Op1) =
        Join(
          ...
          Cross(None),
          Const(CString(field))(line),
          Operate(BuiltInFunction1Op(op1), deref(field))(line)
        )(line)
      ...
      val range = Join(
        ...
        Operate(BuiltInFunction1Op(TimeRange), obj)(line)
      )(line)
