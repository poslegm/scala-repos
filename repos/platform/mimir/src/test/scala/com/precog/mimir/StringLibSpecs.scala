    ...
    "handle valid and invalid inputs" in {
      val input =
        dag.Operate(
          ...
          dag.AbsoluteLoad(Const(CString("/het/stringNums"))(line))(line)
        )(line)
