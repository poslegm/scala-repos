  ...
  "dag memoization" should {
    ...
    "insert memoization nodes for morph1 referenced by morph1 and cross" in {
      ...
      val input = Join(
        ...
        Join(Mul, Cross(None), clicks, clicks)(line)
      )(line)
      ...
      val expected =
        Join(
          ...
          Join(Mul, Cross(None), memoClicks, memoClicks)(line)
        )(line)
    ...
    "insert memoization nodes for split referenced by morph1 and cross" in {
      ...
      val input = Join(
        ...
        Join(Mul, Cross(None), split, split)(line)
      )(line)
      ...
      val expected =
        Join(
          ...
          Join(Mul, Cross(None), memoSplit, memoSplit)(line)
        )(line)
