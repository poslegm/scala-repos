  ...
  "join optimization" should {
    "fail to rewrite in presence of constant join" in {
      ...
      def makeFilter(
        ...
        Filter(
          ...
          Join(Eq, Cross(None), lhs2, rhs2)(line)
        )(line)
    ...
    "eliminate naive cartesian products in trivial object join cases" in {
      ...
      val expectedOpt = Join(
        ...
        Join(
          ...
          Cross(None),
          height,
          Join(DerefObject, Cross(None), liftedLHS, height)(line)
        )(line),
        Join(
          WrapObject,
          Cross(None),
          name,
          Join(DerefObject, Cross(None), liftedRHS, name)(line)
        )(line)
      )(line)
    ...
    "eliminate naive cartesian products in trivial op2 join cases" in {
      ...
      val expectedOpt =
        Join(
          ...
          Join(DerefObject, Cross(None), liftedRHS, height)(line)
        )(line)
    ...
    "eliminate naive cartesian products in slightly less trivial cases (1)" in {
      ...
      val lhs = Join(
        ...
        Join(
          ...
          Cross(None),
          weight,
          Join(DerefObject, Cross(None), heightWeight, weight)(line)
        )(line)
      )(line)
    ...
    "eliminate cartesian with a new inside an array join" in {
      ...
      val medals = dag.AbsoluteLoad(
        Const(CString("/summer_games/london_medals"))(line)
      )(line)
      ...
      val expectedOpt = Join(
        ...
        Join(
          ...
          Operate(
            WrapArray,
            Join(DerefObject, Cross(None), liftedLHS, name)(line)
          )(line)
        )(line),
        Const(CLong(1))(line)
      )(line)
    ...
    "eliminate cartesian with a new and a filter inside an array join" in {
      ...
      val input =
        Filter(
          ...
          Join(
            ...
            Operate(WrapArray, medalsPPcountry)(line)
          )(line),
      ...
      val expectedOpt = Join(
        ...
        Operate(
          WrapArray,
          Join(DerefObject, Cross(None), liftedLHS, country)(line)
        )(line),
        Operate(
          WrapArray,
          Join(DerefObject, Cross(None), liftedRHS, country)(line)
        )(line)
      )(line)
        ...
        Join(
          ...
          Join(
            ...
            Join(
              ...
              Cross(None),
              medalsPrime,
              Const(CString("Medal winner"))(line)
            )(line)
          )(line),
          Join(
            WrapObject,
            ...
            Join(
              ...
              Cross(None),
              athletesPrime,
              Const(CString("Countryname"))(line)
            )(line)
          )(line)
        )(line),
        Join(
      ...
      lazy val expected =
        Join(
          ...
          Join(
            ...
            makeAddSortKey(clicksPid, clicksP)
          )(line)
        )(line)
