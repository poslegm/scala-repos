...
trait SecureVFSModule[M[+_], Block] extends VFSModule[M, Block] {
  ...
  class SecureVFS(
    ...
    final def readResource(
        ...
        version: Version,
        readMode: ReadMode
    ): EitherT[M, ResourceError, Resource] = {
    ...
    final def readQuery(
        ...
        version: Version,
        readMode: ReadMode
    ): EitherT[M, ResourceError, String] = {
    ...
    final def readProjection(
        ...
        version: Version,
        readMode: ReadMode
    ): EitherT[M, ResourceError, Projection] = {
      readResource(apiKey, path, version, readMode) >>=
    ...
    )(implicit M: Monad[M]): EitherT[M, EvaluationError, StoredQueryResult] = {
