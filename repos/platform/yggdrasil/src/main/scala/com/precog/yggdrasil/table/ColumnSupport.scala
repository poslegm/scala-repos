    ...
    ctype match {
      ...
      case CBoolean =>
        new ArraySetColumn[BoolColumn](
          ctype,
          columnSet.map(_.asInstanceOf[BoolColumn])
        ) with BoolColumn {
          def apply(row: Int): Boolean =
            backing(firstDefinedIndexAt(row))
      ...
      case CLong =>
        new ArraySetColumn[LongColumn](
          ctype,
          columnSet.map(_.asInstanceOf[LongColumn])
        ) with LongColumn {
      ...
      case CDate =>
        new ArraySetColumn[DateColumn](
          ctype,
          columnSet.map(_.asInstanceOf[DateColumn])
        ) with DateColumn {
      ...
      case CNull =>
        new ArraySetColumn[NullColumn](
          ctype,
          columnSet.map(_.asInstanceOf[NullColumn])
        ) with NullColumn {}
