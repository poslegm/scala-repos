...
class MavenCacheRepositoryResolver(val repo: MavenCache, settings: IvySettings)
  ...
  protected def setRepository(
      request: AetherMetadataRequest
  ): AetherMetadataRequest = request
  protected def addRepositories(
      request: AetherDescriptorRequest
  ): AetherDescriptorRequest = request
  protected def addRepositories(
      request: AetherArtifactRequest
  ): AetherArtifactRequest = request
  protected def addRepositories(
      request: AetherVersionRequest
  ): AetherVersionRequest = request
  protected def addRepositories(
      request: AetherVersionRangeRequest
  ): AetherVersionRangeRequest = request
