...
object ScalaRoutingSpec extends Specification {
  "the scala router" should {
    ...
    "support optional values for parameters" in {
      ...
      contentOf(
        FakeRequest("GET", "/api/list-all?version=3.0")
      ) must_== "version Some(3.0)"
    }
