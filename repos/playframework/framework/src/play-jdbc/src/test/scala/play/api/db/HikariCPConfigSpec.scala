  ...
  "When reading configuration" should {
    ...
    "set database url" in new Configs {
      new HikariCPConfig(
        dbConfig,
        reference
      ).toHikariConfig.getJdbcUrl must beEqualTo("jdbc:h2:mem:")
    }
    ...
    "set connectionInitSql config" in new Configs {
      ...
      new HikariCPConfig(
        dbConfig,
        config
      ).toHikariConfig.getConnectionInitSql must beEqualTo("SELECT 1")
    }
    ...
    "respect the defaults as" in {
      "autoCommit to true" in new Configs {
        new HikariCPConfig(
          dbConfig,
          reference
        ).toHikariConfig.isAutoCommit must beTrue
      }
      ...
      "connectionTimeout to 30 seconds" in new Configs {
        new HikariCPConfig(
          dbConfig,
          reference
        ).toHikariConfig.getConnectionTimeout must beEqualTo(
          30.seconds.toMillis
        )
      }
      ...
      "idleTimeout to 10 minutes" in new Configs {
        new HikariCPConfig(
          dbConfig,
          reference
        ).toHikariConfig.getIdleTimeout must beEqualTo(10.minutes.toMillis)
      }
      ...
      "maxLifetime to 30 minutes" in new Configs {
        new HikariCPConfig(
          dbConfig,
          reference
        ).toHikariConfig.getMaxLifetime must beEqualTo(30.minutes.toMillis)
      }
      ...
      "validationTimeout to 5 seconds" in new Configs {
        new HikariCPConfig(
          dbConfig,
          reference
        ).toHikariConfig.getValidationTimeout must beEqualTo(5.seconds.toMillis)
      }
      ...
      "minimumIdle to 10" in new Configs {
        new HikariCPConfig(
          dbConfig,
          reference
        ).toHikariConfig.getMinimumIdle must beEqualTo(10)
      }
      ...
      "maximumPoolSize to 10" in new Configs {
        new HikariCPConfig(
          dbConfig,
          reference
        ).toHikariConfig.getMaximumPoolSize must beEqualTo(10)
      }
      ...
      "initializationFailFast to true" in new Configs {
        new HikariCPConfig(
          dbConfig,
          reference
        ).toHikariConfig.isInitializationFailFast must beTrue
      }
      ...
      "isolateInternalQueries to false" in new Configs {
        new HikariCPConfig(
          dbConfig,
          reference
        ).toHikariConfig.isIsolateInternalQueries must beFalse
      }
      ...
      "allowPoolSuspension to false" in new Configs {
        new HikariCPConfig(
          dbConfig,
          reference
        ).toHikariConfig.isAllowPoolSuspension must beFalse
      }
      ...
      "readOnly to false" in new Configs {
        new HikariCPConfig(
          dbConfig,
          reference
        ).toHikariConfig.isReadOnly must beFalse
      }
      ...
      "registerMBeans to false" in new Configs {
        new HikariCPConfig(
          dbConfig,
          reference
        ).toHikariConfig.isRegisterMbeans must beFalse
      }
      ...
      "leakDetectionThreshold to 0 (zero)" in new Configs {
        new HikariCPConfig(
          dbConfig,
          reference
        ).toHikariConfig.getLeakDetectionThreshold must beEqualTo(0)
      }
    }
    ...
    "override the defaults for property" in {
      "autoCommit" in new Configs {
        ...
        new HikariCPConfig(
          dbConfig,
          config
        ).toHikariConfig.isAutoCommit must beFalse
      }
      ...
      "idleTimeout" in new Configs {
        ...
        new HikariCPConfig(
          dbConfig,
          config
        ).toHikariConfig.getIdleTimeout must beEqualTo(5.minutes.toMillis)
      }
      ...
      "maxLifetime" in new Configs {
        ...
        new HikariCPConfig(
          dbConfig,
          config
        ).toHikariConfig.getMaxLifetime must beEqualTo(15.minutes.toMillis)
      }
      ...
      "validationTimeout" in new Configs {
        ...
        new HikariCPConfig(
          dbConfig,
          config
        ).toHikariConfig.getValidationTimeout must beEqualTo(
          10.seconds.toMillis
        )
      }
      ...
      "minimumIdle" in new Configs {
        ...
        new HikariCPConfig(
          dbConfig,
          config
        ).toHikariConfig.getMinimumIdle must beEqualTo(20)
      }
      ...
      "maximumPoolSize" in new Configs {
        ...
        new HikariCPConfig(
          dbConfig,
          config
        ).toHikariConfig.getMaximumPoolSize must beEqualTo(20)
      }
      ...
      "initializationFailFast" in new Configs {
        ...
        new HikariCPConfig(
          dbConfig,
          config
        ).toHikariConfig.isInitializationFailFast must beFalse
      }
      ...
      "isolateInternalQueries" in new Configs {
        ...
        new HikariCPConfig(
          dbConfig,
          config
        ).toHikariConfig.isIsolateInternalQueries must beTrue
      }
      ...
      "allowPoolSuspension" in new Configs {
        ...
        new HikariCPConfig(
          dbConfig,
          config
        ).toHikariConfig.isAllowPoolSuspension must beTrue
      }
      ...
      "readOnly" in new Configs {
        ...
        new HikariCPConfig(
          dbConfig,
          config
        ).toHikariConfig.isReadOnly must beTrue
      }
      ...
      "leakDetectionThreshold" in new Configs {
        ...
        new HikariCPConfig(
          dbConfig,
          config
        ).toHikariConfig.getLeakDetectionThreshold must beEqualTo(3000L)
      }
    }
  }
}
