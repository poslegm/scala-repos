...
trait Enumeratee[From, To] { parent =>
  ...
  def compose[To2](other: Enumeratee[To, To2]): Enumeratee[From, To2] = {
    new Enumeratee[From, To2] {
      def applyOn[A](
          iteratee: Iteratee[To2, A]
      ): Iteratee[From, Iteratee[To2, A]] = {
...
object Enumeratee {
  ...
  def collect[From] =
    new Collect[From] {
      def apply[To](
          transformer: PartialFunction[From, To]
