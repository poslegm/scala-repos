...
object HandlerInvokerFactory {
  ...
  private[play] def javaBodyParserToScala(
      parser: play.mvc.BodyParser[_]
  ): BodyParser[RequestBody] = BodyParser { request =>
    val accumulator =
  ...
  implicit def javaStringPromiseWebSocket
    ...
    new JavaWebSocketInvokerFactory[CompletionStage[LegacyWebSocket[String]], String] {
  ...
  implicit def javaJsonPromiseWebSocket
    ...
    new JavaWebSocketInvokerFactory[CompletionStage[LegacyWebSocket[JsonNode]], JsonNode] {
