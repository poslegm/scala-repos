...
class SubSource[+Out, +Mat](
  ...
  def asScala
      : scaladsl.SubFlow[Out, Mat, scaladsl.Source[Out, Mat]#Repr, scaladsl.RunnableGraph[
        Mat
      ]] @uncheckedVariance = delegate
  ...
  /**
    ...
    */
  def prefixAndTail(n: Int): SubSource[akka.japi.Pair[java.util.List[
