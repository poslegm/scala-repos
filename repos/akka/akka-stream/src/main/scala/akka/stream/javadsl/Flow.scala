...
object Flow {
  ...
  def fromProcessor[I, O](
      processorFactory: function.Creator[Processor[I, O]]
...
final class Flow[-In, +Out, +Mat](delegate: scaladsl.Flow[In, Out, Mat])
  ...
  /**
    ...
    */
  def mapConcat[T](
      f: function.Function[Out, java.lang.Iterable[T]]
  ...
  /**
    ...
    */
  def prefixAndTail(n: Int): javadsl.Flow[In, akka.japi.Pair[java.util.List[
  ...
  ): SubFlow[In, Out @uncheckedVariance, Mat] =
