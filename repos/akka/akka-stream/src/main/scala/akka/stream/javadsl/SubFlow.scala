...
class SubFlow[-In, +Out, +Mat](
  ...
  def asScala
      : scaladsl.SubFlow[Out, Mat, scaladsl.Flow[In, Out, Mat]#Repr, scaladsl.Sink[
        In,
        Mat
      ]] @uncheckedVariance =
    delegate
  ...
  /**
    ...
    */
  def prefixAndTail(n: Int): SubFlow[In, akka.japi.Pair[java.util.List[
