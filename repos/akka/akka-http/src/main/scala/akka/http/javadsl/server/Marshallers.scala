...
object Marshallers {
  ...
  def toEntityString[T](
      ...
      convert: function.Function[T, String]
  ): Marshaller[T] =
    MarshallerImpl(_ ⇒
      ScalaMarshaller
  ...
  def toEntityBytes[T](
      ...
      convert: function.Function[T, Array[Byte]]
  ): Marshaller[T] =
    toEntity(
      contentType,
  ...
  def toEntityByteString[T](
      contentType: ContentType,
      convert: function.Function[T, ByteString]
  ): Marshaller[T] =
    toEntity(
      contentType,
      convert.andThen(scaladsl.model.HttpEntity(contentType.asScala, _))
  ...
  def toEntity[T](
      contentType: ContentType,
      convert: function.Function[T, ResponseEntity]
  ): Marshaller[T] =
    MarshallerImpl { _ ⇒
  ...
  def toResponse[T](
      contentType: ContentType,
      convert: function.Function[T, HttpResponse]
  ): Marshaller[T] =
    MarshallerImpl { _ ⇒
      ScalaMarshaller.withFixedContentType(contentType.asScala)(t ⇒
        convert(t).asScala
