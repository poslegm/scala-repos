...
object ThisFunction {
  ...
  implicit def fromFunction1[T1, R](
      f: scala.Function1[T1, R]
  ): ThisFunction0[T1, R] =
    identity((x1: T1) => f(x1))
  implicit def fromFunction2[T1, T2, R](
      f: scala.Function2[T1, T2, R]
  ): ThisFunction1[T1, T2, R] =
    identity((x1: T1, x2: T2) => f(x1, x2))
  implicit def fromFunction3[T1, T2, T3, R](
      f: scala.Function3[T1, T2, T3, R]
  ): ThisFunction2[T1, T2, T3, R] =
  ...
  implicit def toFunction1[T1, R](
      f: ThisFunction0[T1, R]
  ): scala.Function1[T1, R] = (x1) => f(x1)
  implicit def toFunction2[T1, T2, R](
      f: ThisFunction1[T1, T2, R]
  ): scala.Function2[T1, T2, R] =
    (x1, x2) => f(x1, x2)
  implicit def toFunction3[T1, T2, T3, R](
      f: ThisFunction2[T1, T2, T3, R]
