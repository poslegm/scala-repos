...
object ZippedTraversable3 {
  implicit def zippedTraversable3ToTraversable[El1, El2, El3](
      zz: ZippedTraversable3[El1, El2, El3]
  ): Traversable[(El1, El2, El3)] = {
...
final class Tuple3Zipped[El1, Repr1, El2, Repr2, El3, Repr3](
  ...
  def flatMap[B, To](
      f: (El1, El2, El3) => TraversableOnce[B]
  )(implicit cbf: CBF[Repr1, B, To]): To = {
    val b      = cbf(colls._1.repr)
    val elems2 = colls._2.iterator
    val elems3 = colls._3.iterator
...
object Tuple3Zipped {
  final class Ops[T1, T2, T3](val x: (T1, T2, T3)) extends AnyVal {
    def invert[El1, CC1[X] <: TraversableOnce[X], El2, CC2[
        X
    ] <: TraversableOnce[X], El3, CC3[X] <: TraversableOnce[X], That](implicit
        w1: T1 <:< CC1[El1],
        w2: T2 <:< CC2[El2],
        w3: T3 <:< CC3[El3],
