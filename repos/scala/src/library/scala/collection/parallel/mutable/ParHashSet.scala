...
private[mutable] abstract class ParHashSetCombiner[T](
    private val tableLoadFactor: Int
      ...
      T
    ], AnyRef, ParHashSetCombiner[T]](ParHashSetCombiner.numblocks)
...
//self: EnvironmentPassingCombiner[T, ParHashSet[T]] =>
  ...
  class FillBlocks(
    ...
    private def fillBlock(
        ...
        leftovers: UnrolledBuffer[AnyRef]
    ): (Int, UnrolledBuffer[AnyRef]) = {
...
private[parallel] object ParHashSetCombiner {
  ...
  def apply[T] =
    new ParHashSetCombiner[T](
      FlatHashTable.defaultLoadFactor
    ) {} //with EnvironmentPassingCombiner[T, ParHashSet[T]]
}
