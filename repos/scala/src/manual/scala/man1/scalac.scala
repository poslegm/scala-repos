...
object scalac extends Command {
  ...
  val description = Section(
    ...
    "The " & MBold(
      command
    ) & " tool reads class and object definitions, " & "written in the Scala programming language, and compiles them into " & "bytecode class files.",
      ...
      DefinitionList(
        ...
        Definition(
          ...
          SeqPara(
            ...
            "The default class path is the current directory. Setting the " & Mono(
              "CLASSPATH"
            ) & " variable or using the " & Mono(
              "-classpath"
            ) & " " & "command-line option overrides that default, so if you want to " & "include the current directory in the search path, you must " & "include " & Mono(
              "\".\""
            ) & " in the new settings."
          )
        ),
        ...
        Definition(
          ...
          SeqPara(
            ...
            Mono(
              "\"notailcalls\""
            ) & " generates all of the above and " & Italic(
              "will not"
  ...
  val examples = Section(
    ...
    DefinitionList(
      ...
      Definition(
        "Compile a Scala program using a user-defined " & MBold(
          "java"
        ) & " " & "command",
      ...
      Definition(
        "Compile all Scala files found in the source directory " & MBold(
          "src"
        ) & " to the destination directory " & MBold("classes"),
