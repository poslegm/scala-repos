...
trait Internals extends api.Internals { self: SymbolTable =>
  ...
  trait SymbolTableInternal extends MacroInternalApi {
    ...
    def defDef(
        ...
        rhs: Tree
    ): DefDef = self.DefDef(sym, mods, vparamss, rhs)
