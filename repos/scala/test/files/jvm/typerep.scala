...
object TypeRep {
  ...
  implicit def tuple6Rep[A1, A2, A3, A4, A5, A6](
      ...
      _5: TypeRep[A5],
      _6: TypeRep[A6]
  ): TypeRep[Tuple6[A1, A2, A3, A4, A5, A6]] =
  ...
  implicit def tuple7Rep[A1, A2, A3, A4, A5, A6, A7](
      ...
      _6: TypeRep[A6],
      _7: TypeRep[A7]
  ): TypeRep[Tuple7[A1, A2, A3, A4, A5, A6, A7]] =
  ...
  implicit def tuple8Rep[A1, A2, A3, A4, A5, A6, A7, A8](
      ...
      _7: TypeRep[A7],
      _8: TypeRep[A8]
  ): TypeRep[Tuple8[A1, A2, A3, A4, A5, A6, A7, A8]] =
  ...
  implicit def func4Rep[A1, A2, A3, A4, B](
      ...
      a4: TypeRep[A4],
      b: TypeRep[B]
  ): TypeRep[Function4[A1, A2, A3, A4, B]] =
  ...
  implicit def func5Rep[A1, A2, A3, A4, A5, B](
      ...
      a5: TypeRep[A5],
      b: TypeRep[B]
  ): TypeRep[Function5[A1, A2, A3, A4, A5, B]] =
  ...
  implicit def func6Rep[A1, A2, A3, A4, A5, A6, B](
      ...
      a6: TypeRep[A6],
      b: TypeRep[B]
  ): TypeRep[Function6[A1, A2, A3, A4, A5, A6, B]] =
  ...
  implicit def func7Rep[A1, A2, A3, A4, A5, A6, A7, B](
      ...
      a7: TypeRep[A7],
      b: TypeRep[B]
  ): TypeRep[Function7[A1, A2, A3, A4, A5, A6, A7, B]] =
  ...
  implicit def func8Rep[A1, A2, A3, A4, A5, A6, A7, A8, B](
      ...
      a8: TypeRep[A8],
      b: TypeRep[B]
  ): TypeRep[Function8[A1, A2, A3, A4, A5, A6, A7, A8, B]] =
