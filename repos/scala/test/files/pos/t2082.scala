...
trait MappedForeignKey[KeyType, Owner <: Mapper[Owner], Other <: KeyedMapper[
  KeyType,
  Other
]]
...
object Main {
  ...
  def oneToOneJoin[PType <: KeyedMapper[Long, PType] with IdPK, CType <: KeyedMapper[
    Long,
    CType
  ] with IdPK, CMetaType <: CType with KeyedMetaMapper[Long, CType], FKType <: MappedForeignKey[
    Long,
    PType,
    CType
  ]](
