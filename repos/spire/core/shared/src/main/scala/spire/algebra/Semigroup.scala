...
object Semigroup {
  ...
  @inline final def additive[A](
      implicit A: AdditiveSemigroup[A]
  ): Semigroup[A] = A.additive
  ...
  @inline final def multiplicative[A](
      implicit A: MultiplicativeSemigroup[A]
  ): Semigroup[A] = A.multiplicative
}
...
object CSemigroup {
  ...
  @inline final def additive[A](
      implicit A: AdditiveCSemigroup[A]
  ): CSemigroup[A] = A.additive
  @inline final def multiplicative[A](
      implicit A: MultiplicativeCSemigroup[A]
  ): CSemigroup[A] =
    A.multiplicative
}
