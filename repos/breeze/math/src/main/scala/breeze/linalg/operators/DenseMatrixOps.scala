...
trait DenseMatrixMultiplyStuff
  ...
  implicit object implOpMulMatrix_DMD_DMD_eq_DMD
    ...
    implicitly[BinaryRegistry[Matrix[Double], Matrix[
      Double
    ], OpMulMatrix.type, Matrix[Double]]]
      .register(this)
    implicitly[BinaryRegistry[DenseMatrix[Double], Matrix[
      Double
    ], OpMulMatrix.type, DenseMatrix[Double]]].register(this)
  }
...
trait DenseMatrixFloatMultiplyStuff
  ...
  implicit object implOpMulMatrix_DMF_DMF_eq_DMF
    ...
    implicitly[BinaryRegistry[Matrix[Float], Matrix[
      Float
    ], OpMulMatrix.type, Matrix[Float]]]
      .register(this)
    implicitly[BinaryRegistry[DenseMatrix[Float], Matrix[
      Float
    ], OpMulMatrix.type, DenseMatrix[Float]]].register(this)
  }
  ...
  implicit def op_DM_DM[@expand.args(Int, Long, Float, Double) T]
    ...
    new OpMulMatrix.Impl2[DenseMatrix[T], DenseMatrix[T], DenseMatrix[T]] {
      ...
      implicitly[BinaryRegistry[DenseMatrix[T], Matrix[
        T
      ], OpMulMatrix.type, DenseMatrix[T]]]
        .register(this)
    }
