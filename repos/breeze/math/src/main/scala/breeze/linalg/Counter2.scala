...
/**
  ...
  * @author dlwh
  */
trait Counter2Like[K1, K2, V, +M1[VV] <: Curried[
  scala.collection.mutable.Map,
  K1
]#Result[VV], +T <: Counter[K2, V], +This <: Counter2[K1, K2, V]]
  ...
  private[linalg] def innerGetOrElseUpdate[M](
      k: K1,
      m: scala.collection.mutable.Map[K1, M]
  ): M = {
...
object Counter2 extends LowPriorityCounter2 with Counter2Ops {
  ...
  /** Aggregates the counts in the given items. */
  def apply[K1, K2, V: Semiring: Zero](
      values: TraversableOnce[(K1, K2, V)]
  ): Counter2[K1, K2, V] = {
  ...
  implicit def canTraverseKeyValuePairs[K1, K2, V]
    ...
    new CanTraverseKeyValuePairs[Counter2[K1, K2, V], (K1, K2), V] {
      ...
      override def traverse(
          ...
          fn: KeyValuePairsVisitor[(K1, K2), V]
      ): Unit = {
        for ((k, v) <- from.activeIterator) {
          fn.visit(k, v)
        }
  ...
  implicit def canMapCols[K1, K2, V, R: ClassTag: Zero: Semiring]
      : CanCollapseAxis[Counter2[K1, K2, V], Axis._1.type, Counter[K2, V], Counter[
        K2,
        R
      ], Counter2[K1, K2, R]] =
    new CanCollapseAxis[
...
trait LowPriorityCounter2 {
  ...
  implicit def canCollapseRows[K1, K2, V, R: ClassTag: Zero: Semiring]
      : CanCollapseAxis[Counter2[K1, K2, V], Axis._0.type, Counter[K1, V], R, Counter[
        K2,
        R
      ]] =
    new CanCollapseAxis[
  ...
  implicit def canCollapseCols[K1, K2, V, R: ClassTag: Zero: Semiring]
      : CanCollapseAxis[Counter2[K1, K2, V], Axis._1.type, Counter[K2, V], R, Counter[
        K1,
        R
      ]] =
    new CanCollapseAxis[
