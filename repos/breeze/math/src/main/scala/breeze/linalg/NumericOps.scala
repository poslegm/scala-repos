...
trait ImmutableNumericOps[+This] extends Any {
  ...
  final def t[TT >: This, That, Slice1, Result](a: Slice1)(
      implicit op: CanTranspose[TT, That],
      canSlice: CanSlice[That, Slice1, Result]
  ): Result =
...
object NumericOps {
  ...
  object Arrays extends ArraysLowPriority {
    ...
    implicit def binaryOpFromDVOp2[V, Op <: OpType](
        implicit op: UFunc.UImpl2[Op, DenseVector[V], DenseVector[V], DenseVector[
          V
        ]]
