...
trait ProjectStructureMatcher {
  ...
  private def assertProjectModulesEqual(
      project: Project
  ...
  private def assertModuleContentRootsEqual(
      module: Module
  ...
  private def assertModuleExcludedFoldersEqual(
      module: Module
  )(expected: Seq[String]): Unit = {
    val contentRoot = getSingleContentRoot(module)
    assertContentRootFoldersEqual(
  ...
  private def assertModuleDependenciesEqual(
      module: Module
  ...
  private def assertLibraryDependenciesEqual(
      module: Module
  ...
  private def assertDependencyScopeAndExportedFlagEqual(
      ...
      actual: roots.ExportableOrderEntry
  ): Unit = {
  ...
  private def assertProjectLibrariesEqual(
      project: Project
  ...
  private def assertModuleLibrariesEqual(
      module: Module
  )(expectedLibraries: Seq[library]): Unit = {
