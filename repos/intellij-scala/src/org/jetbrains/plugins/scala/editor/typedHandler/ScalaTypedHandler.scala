...
class ScalaTypedHandler extends TypedHandlerDelegate {
  ...
  override def beforeCharTyped(
    ...
    if ((c == '"' && Set(
        ...
        ).contains(elementType) && element.getTextOffset + element.getTextLength -
  ...
  private def completeScalaDocWikiSyntax(
      tagToInsert: String
  ...
  private def completeXmlTag(
      insert: ScXmlStartTag => String
  )(document: Document, project: Project, element: PsiElement, offset: Int) {
  ...
  private def completeXmlAttributeQuote(
      editor: Editor
  )(document: Document, project: Project, element: PsiElement, offset: Int) {
    if (element != null &&
  ...
  private def getScaladocTask(
      text: String,
      offset: Int
  ): (Document, Project, PsiElement, Int) => Unit = {
  ...
  private def indentParametersComma(
      file: PsiFile
  )(document: Document, project: Project, element: PsiElement, offset: Int) = {
    indentElement(file)(
      document,
  ...
  private def indentDefinitionAssign(
      file: PsiFile
  )(document: Document, project: Project, element: PsiElement, offset: Int) = {
    indentElement(file)(
      document,
  ...
  private def indentValBraceStyle(
      file: PsiFile
  )(document: Document, project: Project, element: PsiElement, offset: Int) = {
    indentElement(file)(
      document,
  ...
  private def startAutopopupCompletion(
      file: PsiFile,
      editor: Editor
  )(document: Document, project: Project, element: PsiElement, offset: Int) {
  ...
  private def convertToInterpolated(
      file: PsiFile,
      editor: Editor
  )(document: Document, project: Project, element: PsiElement, offset: Int) {
  ...
  private def completeEmptyXmlTag(
      editor: Editor
  )(document: Document, project: Project, element: PsiElement, offset: Int) {
    if (element != null &&
