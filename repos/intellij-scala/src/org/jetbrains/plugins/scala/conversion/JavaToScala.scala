...
object JavaToScala {
  ...
  def findVariableUsage(
      ...
      elementWhereFind: PsiElement
  ): Seq[PsiReferenceExpression] = {
  ...
  def createClass(inClass: PsiClass, externalProperties: ExternalProperties)(
    ...
    def handleAsClass(
        ...
        extendList: Seq[PsiJavaCodeReferenceElement]
    ): IntermediateNode = {
      ...
      def sortMembers(): Seq[PsiMember] = {
        ...
        def sort(
            targetMap: mutable.HashMap[PsiMethod, PsiMethod]
        ): Seq[PsiMember] = {
      ...
      def updateMembersAndConvert(
          dropMembes: Option[Seq[PsiMember]]
      ): Seq[IntermediateNode] = {
  ...
  ): mutable.HashMap[PsiMethod, PsiMethod] = {
  ...
  def handlePrimaryConstructor(constructors: Seq[PsiMethod])(
    ...
    def createPrimaryConstructor(
      ...
      def notContains(
          ...
          where: Seq[PsiExpressionStatement]
      ): Boolean = {
      ...
      def getSuperCall(
          dropStatements: ArrayBuffer[PsiExpressionStatement]
      ): IntermediateNode = {
      ...
      def getCorrespondedFieldInfo(
          param: PsiParameter
      ): Seq[(PsiField, PsiExpressionStatement)] = {
