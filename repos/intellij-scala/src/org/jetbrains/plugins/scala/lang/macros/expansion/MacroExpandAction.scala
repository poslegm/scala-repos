...
class MacroExpandAction extends AnAction {
  ...
  def expandMacroUnderCursor(
      expansion: ResolvedMacroExpansion
  ...
  def expandAllMacroInCurrentFile(
  ...
  def applyExpansion(
      resolved: ResolvedMacroExpansion
  ...
  def tryResolveExpansionPlaces(
      expansions: Seq[MacroExpansion]
