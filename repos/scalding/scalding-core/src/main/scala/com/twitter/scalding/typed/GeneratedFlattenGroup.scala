...
object FlattenGroup {
  ...
  implicit def toFlattenLeftJoin4[KEY, KLL[KLL_K, +KLL_V] <: KeyedListLike[
    ...
    KLL_V,
    KLL
  ], A, B, C, D](nested: KLL[KEY, (((A, B), C), D)]) =
  ...
  implicit def toFlattenLeftJoin5[KEY, KLL[KLL_K, +KLL_V] <: KeyedListLike[
    ...
    KLL_V,
    KLL
  ], A, B, C, D, E](nested: KLL[KEY, ((((A, B), C), D), E)]) =
  ...
  class FlattenLeftJoin6[
    ...
    def flattenValueTuple: KLL[KEY, (A, B, C, D, E, F)] = nested.mapValues {
      tup => FlattenGroup.flattenNestedTuple(tup)
    }
  }
  ...
  implicit def toFlattenLeftJoin6[KEY, KLL[KLL_K, +KLL_V] <: KeyedListLike[
    ...
    KLL_V,
    KLL
  ], A, B, C, D, E, F](nested: KLL[KEY, (((((A, B), C), D), E), F)]) =
  ...
  implicit def toFlattenOuterJoin3[KEY, KLL[KLL_K, +KLL_V] <: KeyedListLike[
    KLL_K,
    KLL_V,
    KLL
  ], A, B, C](nested: KLL[KEY, (Option[(Option[A], Option[B])], Option[C])]) =
  ...
  class FlattenOuterJoin4[
    ...
    def flattenValueTuple
        : KLL[KEY, (Option[A], Option[B], Option[C], Option[D])] =
      nested.mapValues { tup => FlattenGroup.flattenNestedOptionTuple(tup) }
  }

  implicit def toFlattenOuterJoin4[KEY, KLL[KLL_K, +KLL_V] <: KeyedListLike[
    KLL_K,
    KLL_V,
    KLL
  ], A, B, C, D](
  ...
  class FlattenOuterJoin5[
    ...
    def flattenValueTuple
        : KLL[KEY, (Option[A], Option[B], Option[C], Option[D], Option[E])] =
      nested.mapValues { tup => FlattenGroup.flattenNestedOptionTuple(tup) }
  }
