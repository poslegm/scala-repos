...
object MatrixProduct extends java.io.Serializable {
  ...
  implicit def literalScalarRightProduct[Row, Col, ValT](
      implicit ring: Ring[ValT]
  ): MatrixProduct[Matrix[Row, Col, ValT], LiteralScalar[ValT], Matrix[
    Row,
    Col,
    ValT
  ]] =
    new MatrixProduct[Matrix[Row, Col, ValT], LiteralScalar[ValT], Matrix[
      Row,
      Col,
      ValT
    ]] {
  ...
  implicit def literalRightProduct[Row, Col, ValT](
      implicit ring: Ring[ValT]
  ...
  implicit def literalScalarLeftProduct[Row, Col, ValT](
      implicit ring: Ring[ValT]
  ): MatrixProduct[LiteralScalar[ValT], Matrix[Row, Col, ValT], Matrix[
    Row,
    Col,
    ValT
  ]] =
    new MatrixProduct[LiteralScalar[ValT], Matrix[Row, Col, ValT], Matrix[
      Row,
      Col,
      ValT
    ]] {
  ...
  implicit def scalarPipeRightProduct[Row, Col, ValT](
      implicit ring: Ring[ValT]
  ): MatrixProduct[Matrix[Row, Col, ValT], Scalar[ValT], Matrix[
    Row,
    Col,
    ValT
  ]] =
    new MatrixProduct[Matrix[Row, Col, ValT], Scalar[ValT], Matrix[
      Row,
      Col,
      ValT
    ]] {
  ...
  implicit def scalarPipeLeftProduct[Row, Col, ValT](
      implicit ring: Ring[ValT]
  ): MatrixProduct[Scalar[ValT], Matrix[Row, Col, ValT], Matrix[
    Row,
    Col,
    ValT
  ]] =
    new MatrixProduct[Scalar[ValT], Matrix[Row, Col, ValT], Matrix[
      Row,
      Col,
      ValT
    ]] {
  ...
  implicit def litScalarRowRightProduct[Col, ValT](
      implicit ring: Ring[ValT]
  ): MatrixProduct[RowVector[Col, ValT], LiteralScalar[ValT], RowVector[
    Col,
    ValT
  ]] =
    new MatrixProduct[RowVector[Col, ValT], LiteralScalar[ValT], RowVector[
      Col,
      ValT
    ]] {
      def apply(
          left: RowVector[Col, ValT],
          right: LiteralScalar[ValT]
      ): RowVector[Col, ValT] = {
        val prod = left.toMatrix(0) * right
  ...
  implicit def litScalarRowLeftProduct[Col, ValT](
      implicit ring: Ring[ValT]
  ): MatrixProduct[LiteralScalar[ValT], RowVector[Col, ValT], RowVector[
    Col,
    ValT
  ]] =
    new MatrixProduct[LiteralScalar[ValT], RowVector[Col, ValT], RowVector[
      Col,
      ValT
    ]] {
      def apply(
  ...
  implicit def litScalarColRightProduct[Row, ValT](
      implicit ring: Ring[ValT]
  ): MatrixProduct[ColVector[Row, ValT], LiteralScalar[ValT], ColVector[
    Row,
    ValT
  ]] =
    new MatrixProduct[ColVector[Row, ValT], LiteralScalar[ValT], ColVector[
      Row,
      ValT
    ]] {
      def apply(
  ...
  implicit def litScalarColLeftProduct[Row, ValT](
      implicit ring: Ring[ValT]
  ): MatrixProduct[LiteralScalar[ValT], ColVector[Row, ValT], ColVector[
    Row,
    ValT
  ]] =
    new MatrixProduct[LiteralScalar[ValT], ColVector[Row, ValT], ColVector[
      Row,
      ValT
    ]] {
      def apply(
  ...
  implicit def scalarDiagRightProduct[Row, ValT](
      implicit ring: Ring[ValT]
  ): MatrixProduct[DiagonalMatrix[Row, ValT], Scalar[ValT], DiagonalMatrix[
    Row,
    ValT
  ]] =
    new MatrixProduct[DiagonalMatrix[Row, ValT], Scalar[ValT], DiagonalMatrix[
      Row,
      ValT
    ]] {
      def apply(
  ...
  implicit def scalarDiagLeftProduct[Row, ValT](
      implicit ring: Ring[ValT]
  ): MatrixProduct[Scalar[ValT], DiagonalMatrix[Row, ValT], DiagonalMatrix[
    Row,
    ValT
  ]] =
    new MatrixProduct[Scalar[ValT], DiagonalMatrix[Row, ValT], DiagonalMatrix[
      Row,
      ValT
    ]] {
      def apply(
          left: Scalar[ValT],
          right: DiagonalMatrix[Row, ValT]
      ): DiagonalMatrix[Row, ValT] = {
  ...
  implicit def litScalarDiagRightProduct[Col, ValT](
      implicit ring: Ring[ValT]
  ): MatrixProduct[DiagonalMatrix[Col, ValT], LiteralScalar[ValT], DiagonalMatrix[
    Col,
    ValT
  ]] =
    new MatrixProduct[DiagonalMatrix[Col, ValT], LiteralScalar[ValT], DiagonalMatrix[
      Col,
      ValT
    ]] {
      def apply(
  ...
  implicit def litScalarDiagLeftProduct[Col, ValT](
      implicit ring: Ring[ValT]
  ): MatrixProduct[LiteralScalar[ValT], DiagonalMatrix[Col, ValT], DiagonalMatrix[
    Col,
    ValT
  ]] =
    new MatrixProduct[LiteralScalar[ValT], DiagonalMatrix[Col, ValT], DiagonalMatrix[
      Col,
      ValT
    ]] {
      def apply(
          left: LiteralScalar[ValT],
          right: DiagonalMatrix[Col, ValT]
      ): DiagonalMatrix[Col, ValT] = {
        val prod = (right.toCol.toMatrix(0)) * left
  ...
  implicit def rowMatrixProduct[Common, ColR, ValT](
      implicit ring: Ring[ValT]
  ): MatrixProduct[RowVector[Common, ValT], Matrix[Common, ColR, ValT], RowVector[
    ColR,
    ValT
  ]] =
    new MatrixProduct[
  ...
  implicit def matrixColProduct[RowR, Common, ValT](
      implicit ring: Ring[ValT]
  ): MatrixProduct[Matrix[RowR, Common, ValT], ColVector[Common, ValT], ColVector[
    RowR,
    ValT
  ]] =
    new MatrixProduct[
  ...
  implicit def vectorOuterProduct[RowT, ColT, ValT](
      implicit ring: Ring[ValT]
  ): MatrixProduct[ColVector[RowT, ValT], RowVector[ColT, ValT], Matrix[
    RowT,
    ColT,
    ValT
  ]] =
  ...
  implicit def standardMatrixProduct[RowL, Common, ColR, ValT](
      implicit ring: Ring[ValT]
  ): MatrixProduct[Matrix[RowL, Common, ValT], Matrix[Common, ColR, ValT], Matrix[
    RowL,
    ColR,
    ValT
  ]] =
  ...
  implicit def diagMatrixProduct[RowT, ColT, ValT](
      implicit ring: Ring[ValT]
  ): MatrixProduct[DiagonalMatrix[RowT, ValT], Matrix[RowT, ColT, ValT], Matrix[
    RowT,
    ColT,
    ValT
  ]] =
  ...
  implicit def matrixDiagProduct[RowT, ColT, ValT](
      implicit ring: Ring[ValT]
  ): MatrixProduct[Matrix[RowT, ColT, ValT], DiagonalMatrix[ColT, ValT], Matrix[
    RowT,
    ColT,
    ValT
  ]] =
  ...
  implicit def diagDiagProduct[IdxT, ValT](
      implicit ring: Ring[ValT]
  ): MatrixProduct[DiagonalMatrix[IdxT, ValT], DiagonalMatrix[IdxT, ValT], DiagonalMatrix[
    IdxT,
    ValT
  ]] =
    new MatrixProduct[
  ...
  implicit def diagColProduct[IdxT, ValT](
      implicit ring: Ring[ValT]
  ): MatrixProduct[DiagonalMatrix[IdxT, ValT], ColVector[IdxT, ValT], ColVector[
    IdxT,
    ValT
  ]] =
    new MatrixProduct[
  ...
  implicit def rowDiagProduct[IdxT, ValT](
      implicit ring: Ring[ValT]
  ): MatrixProduct[RowVector[IdxT, ValT], DiagonalMatrix[IdxT, ValT], RowVector[
    IdxT,
    ValT
  ]] =
    new MatrixProduct[
