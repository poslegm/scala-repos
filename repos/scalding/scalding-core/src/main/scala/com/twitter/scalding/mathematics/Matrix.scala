...
class MatrixPipeExtensions(pipe: Pipe) {
  ...
  def mapToBlockMatrix[T, GroupT, RowT, ColT, ValT](
      fields: Fields
...
object Matrix {
  ...
  implicit def diagonalToMatrix[RowT, ValT](
      diag: DiagonalMatrix[RowT, ValT]
  ): Matrix[RowT, RowT, ValT] = {
...
class Matrix[RowT, ColT, ValT](
  ...
  def mapCols(
      fn: Iterable[(RowT, ValT)] => Iterable[(RowT, ValT)]
  )(implicit mon: Monoid[ValT]): Matrix[RowT, ColT, ValT] = {
  ...
  def elemWiseOp(that: Matrix[RowT, ColT, ValT])(
      fn: (ValT, ValT) => ValT
  )(implicit mon: Monoid[ValT]): Matrix[RowT, ColT, ValT] = {
  ...
  def toBlockMatrix[G](
      grouping: (RowT) => (G, RowT)
  ): BlockMatrix[G, RowT, ColT, ValT] = {
    inPipe
...
class RowVector[ColT, ValT](
  ...
  /**
    ...
    */
  def propagate[MatColT](
      mat: Matrix[ColT, MatColT, Boolean]
