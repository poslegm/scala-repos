...
class ApiController1()(implicit val swagger: Swagger)
  ...
  val listFoos =
    (apiOperation[List[String]](
      "listFoos"
    ) summary "Show all foos" notes "Shows all available foos.")
  ...
  val getFoo =
    (apiOperation[String](
      "getFoo"
    ) summary "Retrieve a single foo by id" notes "Foo" parameters Parameter(
      "id",
      DataType.Int,
      Some("The id"),
      None,
...
class ApiController2()(implicit val swagger: Swagger)
  ...
  val listFoos =
    (apiOperation[List[String]](
      "listBars"
    ) summary "Show all bars" notes "Shows all available bars.")
  ...
  val getBar =
    (apiOperation[String](
      "getBar"
    ) summary "Retrieve a single bar by id" notes "Bar" parameters Parameter(
      "id",
      DataType.Int,
      Some("The id"),
      None,
