    ...
    get("/api-docs") {
      ...
      bd must beSome[JValue] and {
        ...
        (j \ "apiVersion" must_== listResourceJValue \ "apiVersion") and
          ...
          j \ "info"
        ) and verifyApis(j \ "apis") and verifyAuthorizations(
          j \ "authorizations"
        )
      }
    }
  ...
  def listPetOperations = {
    get("/api-docs/pet") {
      ...
      bo must beSome[JValue] and verifyCommon(
        bo.get,
        petOperationsJValue,
        List("/pet/{petId}", "/pet/findByTags", "/pet/findByStatus", "/pet/")
      ) and petOperations
...
class SwaggerTestServlet(protected val swagger: Swagger)
  ...
  val getPet =
    (apiOperation[Pet](
      "getPetById"
    ) summary "Find pet by ID" notes "Returns a pet based on ID" responseMessages
  ...
  val createPet =
    (apiOperation[Unit](
      "addPet"
    ) summary "Add a new pet to the store" responseMessage StringResponseMessage(
      405,
      "Invalid input"
  ...
  val updatePet =
    (apiOperation[Unit](
      "updatePet"
    ) summary "Update an existing pet" responseMessage StringResponseMessage(
      400,
      "Invalid ID supplied"
    ) responseMessage StringResponseMessage(
      404,
      "Pet not found"
    ) responseMessage StringResponseMessage(
      405,
  ...
  val deletePet =
    (apiOperation[Unit](
      "deletePet"
    ) summary "Deletes a pet" responseMessage StringResponseMessage(
      400,
      "Invalid pet value"
  ...
  val findByStatus =
    (apiOperation[List[Pet]](
      "findPetsByStatus"
    ).deprecate summary "Finds Pets by status" notes "Multiple status values can be provided with comma separated strings" produces
      ("application/json",
      ...
      (queryParam[String](
        "status"
      ).required.multiValued description "Status values that need to be considered for filter" defaultValue "available" allowableValues
  ...
  val findByTags =
    (apiOperation[List[Pet]](
      "findPetsByTags"
    ).deprecate summary "Finds Pets by tags" notes "Multiple tags can be provided with comma separated strings. Use tag1, tag2, tag3 for testing." produces
      ("application/json",
      "application/xml") responseMessage StringResponseMessage(
      400,
      "Invalid tag value"
...
class StoreApi(val swagger: Swagger)
  ...
  val getOrderOperation =
    (apiOperation[Order](
      "getOrderById"
    ) summary "Find purchase order by ID" notes "For valid response try integer IDs with value <= 5. Anything above 5 or nonintegers will generate API errors" produces
      ("application/json",
  ...
  val deleteOrderOperation =
    (apiOperation[Unit](
      "deleteOrder"
    ) summary "Delete purchase order by ID" notes "For valid response try integer IDs with value < 1000. Anything above 1000 or nonintegers will generate API errors" responseMessages
      (StringResponseMessage(400, "Invalid ID supplied"),
      StringResponseMessage(404, "Order not found")))
  ...
  val placeOrderOperation =
    (apiOperation[Unit](
      "placeOrder"
    ) summary "Place an order for a pet" responseMessage StringResponseMessage(
      400,
      "Invalid order"
