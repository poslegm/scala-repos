...
trait RecordTypeMode extends PrimitiveTypeMode {
    ...
    fieldReference match {
      ...
      case None =>
        new ConstantExpressionNode[Timestamp](
          new Timestamp(f.get.getTimeInMillis)
  ...
  implicit def calendarFieldQuery2RightHandSideOfIn[F <: TypedField[Calendar]](
      q: org.squeryl.Query[F]
  ) = new RightHandSideOfIn[Timestamp](q.ast)
  ...
  implicit def optionEnum2ScalaEnum[EnumType <: Enumeration](
      f: OptionalTypedField[EnumType#Value]
  )(implicit m: Manifest[EnumType]) =
    fieldReference match {
      case Some(e) =>
  ...
  implicit def optionEnumField2OptionEnum[EnumType <: Enumeration](
      f: Option[TypedField[EnumType#Value]]
  )(implicit m: Manifest[EnumType]) =
    fieldReference match {
      case Some(e) =>
        new SelectElementReference[Enumeration#Value](e)(
      ...
      case None =>
        new ConstantExpressionNode[Enumeration#Value](getValue(f).orNull)({
          val enumOption =
            f flatMap { f1: TypedField[EnumType#Value] => f1.valueBox.toOption }
...
trait SquerylRecordNumericalExpression[T] {
  ...
  /**
    ...
    */
  def defineAs(
      columnAttributes: AttributeValidOnNumericalColumn*
...
trait SquerylRecordNonNumericalExpression[T] {
  ...
  /**
    ...
    */
  def defineAs(
      columnAttributes: AttributeValidOnNonNumericalColumn*
  )(implicit restrictUsageWithinSchema: Schema) = {
    is(columnAttributes: _*)(restrictUsageWithinSchema)
  }
}
