...
object CoproductTest extends SpecLite {
  ...
  object instances {
    ...
    def invariantfunctor[F[_]: Comonad: Traverse: Contravariant, G[_]: Comonad: Traverse: Contravariant] =
      InvariantFunctor[Coproduct[F, G, ?]]
    def invariantfunctor[F[_]: Functor: Contravariant, G[_]: Functor: Contravariant] =
      InvariantFunctor[Coproduct[F, G, ?]]
