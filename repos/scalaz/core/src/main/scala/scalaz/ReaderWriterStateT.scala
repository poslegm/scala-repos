...
sealed abstract class IndexedReaderWriterStateT[F[_], -R, W, -S1, S2, A] {
  ...
  def flatMap[B, RR <: R, S3](
      ...
      F: Bind[F],
      W: Semigroup[W]
  ): IndexedReaderWriterStateT[F, RR, W, S1, S3, B] =
...
object IndexedReaderWriterStateT
  ...
  def create[F[_], R, W, S1, S2, A](
      f: Monad[F] => (R, S1) => F[(W, A, S2)]
  ): IndexedReaderWriterStateT[F, R, W, S1, S2, A] =
    new IndexedReaderWriterStateT[F, R, W, S1, S2, A] {
      override def getF[S <: S1, RR <: R]
          : Monad[F] => F[(RR, S) => F[(W, A, S2)]] =
...
sealed abstract class IndexedReaderWriterStateTInstances0
  ...
  implicit def rwstBind[F[_], R, W, S](implicit
      F0: Bind[F],
      W0: Semigroup[W]
  ): Bind[ReaderWriterStateT[F, R, W, S, ?]] =
...
sealed abstract class IndexedReaderWriterStateTInstances
  ...
  implicit def rwstBindRec[F[_], R, W, S](implicit
      ...
      F1: Monad[F],
      W0: Semigroup[W]
  ): BindRec[ReaderWriterStateT[F, R, W, S, ?]] =
...
sealed abstract class ReaderWriterStateTInstances0
  ...
  implicit def rwstMonad[F[_], R, W, S](implicit
      W0: Monoid[W],
      F0: Monad[F]
  ): MonadReader[ReaderWriterStateT[F, R, W, S, ?], R]
...
abstract class ReaderWriterStateTInstances
  ...
  implicit def rwstMonadPlus[F[_], R, W, S](implicit
      W0: Monoid[W],
      F0: MonadPlus[F]
  ): MonadPlus[ReaderWriterStateT[F, R, W, S, ?]] =
...
private trait ReaderWriterStateTBind[F[_], R, W, S]
  ...
  override final def bind[A, B](
      fa: ReaderWriterStateT[F, R, W, S, A]
...
private trait ReaderWriterStateTBindRec[F[_], R, W, S]
  ...
  def tailrecM[A, B](
      f: A => ReaderWriterStateT[F, R, W, S, A \/ B]
...
private trait ReaderWriterStateTMonad[F[_], R, W, S]
  ...
  def local[A](
      f: R => R
  )(fa: ReaderWriterStateT[F, R, W, S, A]): ReaderWriterStateT[F, R, W, S, A] =
    ReaderWriterStateT((r, s) => fa.run(f(r), s))
  override def scope[A](
      k: R
  )(fa: ReaderWriterStateT[F, R, W, S, A]): ReaderWriterStateT[F, R, W, S, A] =
  ...
  def listen[A](
      ma: ReaderWriterStateT[F, R, W, S, A]
...
private trait ReaderWriterStateTHoist[R, W, S]
  ...
  def hoist[M[_], N[_]](f: M ~> N)(implicit M: Monad[M]) =
    new (ReaderWriterStateT[M, R, W, S, ?] ~> ReaderWriterStateT[
      ...
      def apply[A](
          ma: ReaderWriterStateT[M, R, W, S, A]
