...
trait UnwriterTFunctions {
  ...
  def unput[F[_], W, A](
      value: F[A]
  )(w: W)(implicit F: Functor[F]): UnwriterT[F, W, A] =
  ...
  def unputWith[F[_], W, A](
      value: F[A]
  )(w: A => W)(implicit F: Functor[F]): UnwriterT[F, W, A] =
