...
sealed abstract class IterateeT[E, F[_], A] {
  ...
  /**
    ...
    */
  def advance[EE, AA, G[_]](
      f: StepT[E, F, A] => IterateeT[EE, G, AA]
  )(implicit MO: G |>=| F): IterateeT[EE, G, AA] = {
    iterateeT(MO.MG.bind(MO.promote(value))(s => f(s).value))
  }

  def advanceT[EE, AA, G[_]](
      f: StepT[E, F, A] => G[StepT[EE, F, AA]]
  ...
  /**
    ...
    */
  def >>==[EE, AA](
      f: StepT[E, F, A] => IterateeT[EE, F, AA]
...
trait IterateeTFunctions {
  ...
  def foldM[E, F[_], A](
      init: A
  )(f: (A, E) => F[A])(implicit m: Monad[F]): IterateeT[E, F, A] = {
    def step(acc: A): Input[E] => IterateeT[E, F, A] =
      s =>
        s(
          el = e =>
...
private trait IterateeTMonad[E, F[_]] extends Monad[IterateeT[E, F, ?]] {
  ...
  override def map[A, B](fa: IterateeT[E, F, A])(
      f: A => B
  ): IterateeT[E, F, B] = fa map f
  def bind[A, B](fa: IterateeT[E, F, A])(
      f: A => IterateeT[E, F, B]
  ): IterateeT[E, F, B] = fa flatMap f
}
