...
class RecordTests {
  ...
  def testFromMap2 {
    ...
    type T = FieldType[intField1.type, Int] :: FieldType[
      stringField1.type,
      String
    ] :: FieldType[boolField1.type, Boolean] :: FieldType[
      doubleField1.type,
      Double
    ] :: HNil
  ...
  def testAppendLiteral {
    ...
    typed[FieldType[wIntField1.T, Int] :: FieldType[
      wStringField1.T,
      String
    ] :: FieldType[wBoolField1.T, Boolean] :: FieldType[
      wDoubleField1.T,
      Double
    ] :: HNil](r3)
    assertEquals(
    ...
    typed[
      (
          ...
          FieldType[intField1.type, Int] :: FieldType[
            stringField1.type,
            String
          ] :: FieldType[boolField1.type, Boolean] :: HNil
      )
    ](rm4)
    ...
    typed[
      (
          ...
          FieldType[wStringField1.T, String] :: FieldType[
            wBoolField1.T,
            Boolean
          ] :: FieldType[wDoubleField1.T, Double] :: HNil
      )
    ](rm1)
    assertEquals(23, rm1._1)
    assertEquals(
    ...
    typed[
      (
          ...
          FieldType[wIntField1.T, Int] :: FieldType[
            wStringField1.T,
            String
          ] :: FieldType[wBoolField1.T, Boolean] :: HNil
      )
    ](rm4)
    assertEquals(2.0, rm4._1, Double.MinPositiveValue)
    assertEquals(
  ...
  def testSwapRecord {
    ...
    val fields: (FieldType[Int, x.T] :: FieldType[String, y.T] :: FieldType[
      Boolean,
      z.T
    ] :: HNil) = SwapRecord[TestRecord].apply
