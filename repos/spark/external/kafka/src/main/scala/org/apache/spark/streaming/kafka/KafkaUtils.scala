...
object KafkaUtils {
  ...
  /**
    ...
    * @return DStream of (Kafka message key, Kafka message value)
    */
  def createStream[K: ClassTag, V: ClassTag, U <: Decoder[_]: ClassTag, T <: Decoder[
    _
  ]: ClassTag](
      ssc: StreamingContext,
  ...
  /**
    ...
    */
  def createRDD[K: ClassTag, V: ClassTag, KD <: Decoder[K]: ClassTag, VD <: Decoder[
    V
  ]: ClassTag](
      sc: SparkContext,
      kafkaParams: Map[String, String],
  ...
  /**
    ...
    * @return DStream of R
    */
  def createDirectStream[K: ClassTag, V: ClassTag, KD <: Decoder[K]: ClassTag, VD <: Decoder[
    V
  ]: ClassTag, R: ClassTag](
      ssc: StreamingContext,
      kafkaParams: Map[String, String],
...
private[kafka] class KafkaUtilsPythonHelper {
  ...
  private def createDirectStream[V: ClassTag](
    ...
    KafkaUtils
      .createDirectStream[Array[Byte], Array[Byte], DefaultDecoder, DefaultDecoder, V](
        jssc.ssc,
        Map(kafkaParams.asScala.toSeq: _*),
