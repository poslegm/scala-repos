  ...
  private def matchAlterTableCommands(
    ...
    otherNodes match {
      ...
      case Token(
            ...
            Token(serdeClassName, Nil) :: serdeArgs
          ) :: _ =>
      ...
      case Token(
            ...
            Token("TOK_ALTERTABLE_BUCKETS", b) :: Nil
          ) :: _ =>
        ...
        AlterTableStorageProperties(
          tableIdent,
          BucketSpec(numBuckets, clusterCols, sortCols)
        )(node.source)

      // ALTER TABLE table_name NOT CLUSTERED
      case Token(
            "TOK_ALTERTABLE_CLUSTER_SORT",
            Token("TOK_NOT_CLUSTERED", Nil) :: Nil
          ) :: _ =>
      ...
      case Token(
            ...
            Token(
              "TOK_TABLESKEWED",
              Token("TOK_TABCOLNAME", colNames) :: colValues :: rest
            ) :: Nil
          ) :: _ =>
        // Example format:
        //
      ...
      case Token(
            "TOK_ALTERTABLE_SKEWED",
            Token("TOK_STOREDASDIRS", Nil) :: Nil
          ) :: _ =>
      ...
      case Token(
            ...
            Token(
              ...
              Token("TOK_SKEWED_LOCATION_LIST", locationMaps) :: Nil
            ) :: Nil
          ) :: _ =>
        // Example format:
        //
      ...
      case Token(
            ...
            Token(compactType, Nil) :: Nil
          ) :: _ =>
        AlterTableCompact(
          tableIdent,
          partition,
          cleanAndUnquoteString(compactType)
        )(node.source)
