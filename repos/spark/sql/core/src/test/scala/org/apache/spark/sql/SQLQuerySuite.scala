...
class SQLQuerySuite extends QueryTest with SharedSQLContext {
  ...
  test("left outer join") {
    checkAnswer(
      ...
      Row(1, "A", 1, "a") :: Row(2, "B", 2, "b") :: Row(3, "C", 3, "c") :: Row(
        ...
        4,
        "d"
      ) :: Row(5, "E", null, null) :: Row(6, "F", null, null) :: Nil
    )
  }
  ...
  test("right outer join") {
    checkAnswer(
      ...
      Row(1, "a", 1, "A") :: Row(2, "b", 2, "B") :: Row(3, "c", 3, "C") :: Row(
        ...
        4,
        "D"
      ) :: Row(null, null, 5, "E") :: Row(null, null, 6, "F") :: Nil
    )
  }
  ...
  test("full outer join") {
    checkAnswer(
      ...
      Row(1, "A", null, null) :: Row(2, "B", null, null) :: Row(
        ...
        3,
        "C"
      ) :: Row(4, "D", 4, "D") :: Row(null, null, 5, "E") :: Row(
        null,
        null,
        6,
        "F"
  ...
  test("UNION") {
    checkAnswer(
      ...
      Row(1, "A") :: Row(1, "a") :: Row(2, "B") :: Row(2, "b") :: Row(
        3,
        "C"
      ) :: Row(3, "c") :: Row(4, "D") :: Row(4, "d") :: Row(5, "E") :: Row(
        6,
        "F"
      ) :: Nil
    )
  ...
  test("apply schema") {
    ...
    checkAnswer(
      ...
      Row(Row(1, true), Map("A1" -> null)) :: Row(
        Row(2, false),
        Map("B2"                      -> null)
      ) :: Row(Row(3, true), Map("C3" -> null)) :: Row(
        Row(4, true),
        Map("D4" -> 2147483644)
      ) :: Nil
    )
  ...
  test("SPARK-8753: add interval type") {
    ...
    assert(
      e1.message
        .contains("at least one time unit should be given for interval literal")
    )
  ...
  test("rollup") {
    checkAnswer(
      ...
      Row(null, null, 113000.0) :: Row("Java", null, 50000.0) :: Row(
        ...
        2012,
        20000.0
      ) :: Row("Java", 2013, 30000.0) :: Row("dotNET", null, 63000.0) :: Row(
        "dotNET",
        2012,
        15000.0
  ...
  test("grouping sets when aggregate functions containing groupBy columns") {
    checkAnswer(
      ...
      Row(null, 113000.0) :: Row("Java", 20000.0) :: Row(
        "Java",
        30000.0
      ) :: Row("Java", 50000.0) :: Row("dotNET", 5000.0) :: Row(
        "dotNET",
        10000.0
      ) :: Row("dotNET", 48000.0) :: Row("dotNET", 63000.0) :: Nil
    )
    ...
    checkAnswer(
      ...
      Row(null, 113000.0, 3) :: Row("Java", 20000.0, 0) :: Row(
        ...
        30000.0,
        0
      ) :: Row("Java", 50000.0, 1) :: Row("dotNET", 5000.0, 0) :: Row(
        "dotNET",
        10000.0,
        0
  ...
  test("cube") {
    checkAnswer(
      ...
      Row("Java", 2012, 20000.0) :: Row("Java", 2013, 30000.0) :: Row(
        ...
        null,
        50000.0
      ) :: Row("dotNET", 2012, 15000.0) :: Row("dotNET", 2013, 48000.0) :: Row(
        "dotNET",
        null,
        63000.0
      ) :: Row(null, 2012, 35000.0) :: Row(null, 2013, 78000.0) :: Row(
        null,
        null,
        113000.0
      ) :: Nil
  ...
  test("grouping and grouping_id") {
    checkAnswer(
      ...
      Row("Java", 2012, 0, 0, 0) :: Row("Java", 2013, 0, 0, 0) :: Row(
        ...
        1,
        1
      ) :: Row("dotNET", 2012, 0, 0, 0) :: Row("dotNET", 2013, 0, 0, 0) :: Row(
        "dotNET",
        null,
        0,
        1,
        1
      ) :: Row(null, 2012, 1, 0, 2) :: Row(null, 2013, 1, 0, 2) :: Row(
        null,
        null,
        1,
        1,
    ...
    withTempTable("t1", "t2", "t3") {
      ...
      checkAnswer(
        ...
        Row("r1c1", "r1c2", "t1r1c3", "r1c2", "t2r1c3") :: Row(
          ...
          "r2c2",
          "t2r2c3"
        ) :: Row("r3c1x", "r3c2", "t1r3c3", null, null) :: Row(
          "r3c1y",
          null,
          null,
          "r3c2",
