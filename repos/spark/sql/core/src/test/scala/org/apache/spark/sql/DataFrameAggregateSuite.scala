...
class DataFrameAggregateSuite extends QueryTest with SharedSQLContext {
  ...
  test("grouping/grouping_id inside window function") {
    ...
    checkAnswer(
      ...
      Row("Java", 2012, 20000.0, 0, 2) :: Row(
        "Java",
        2013,
        30000.0,
        0,
        3
      ) :: Row("Java", null, 50000.0, 1, 1) :: Row(
        "dotNET",
        2012,
        15000.0,
        0,
        1
      ) :: Row("dotNET", 2013, 48000.0, 0, 4) :: Row(
        "dotNET",
        null,
        63000.0,
        1,
        2
      ) :: Row(null, 2012, 35000.0, 2, 1) :: Row(
        null,
        2013,
        78000.0,
        2,
  ...
  test("rollup overlapping columns") {
    checkAnswer(
      ...
      Row(2, 1, 0) :: Row(3, 2, -1) :: Row(3, 1, 1) :: Row(4, 2, 0) :: Row(
        ...
        1,
        2
      ) :: Row(5, 2, 1) :: Row(2, null, 0) :: Row(3, null, 0) :: Row(
        4,
        null,
        2
    ...
    checkAnswer(
      ...
      Row(1, 1, 1) :: Row(1, 2, 2) :: Row(2, 1, 1) :: Row(2, 2, 2) :: Row(
        ...
        1,
        1
      ) :: Row(3, 2, 2) :: Row(1, null, 3) :: Row(2, null, 3) :: Row(
        3,
        null,
        3
      ) :: Row(null, null, 9) :: Nil
  ...
  test("cube overlapping columns") {
    checkAnswer(
      ...
      Row(2, 1, 0) :: Row(3, 2, -1) :: Row(3, 1, 1) :: Row(4, 2, 0) :: Row(
        ...
        null,
        2
      ) :: Row(5, null, 1) :: Row(null, 1, 3) :: Row(null, 2, 0) :: Row(
        null,
        null,
        3
      ) :: Nil
