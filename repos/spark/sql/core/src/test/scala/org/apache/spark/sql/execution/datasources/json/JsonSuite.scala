  ...
  ignore("Type conflict in primitive field values (Ignored)") {
    ...
    checkAnswer(
      ...
      Row(BigDecimal("14.3")) :: Row(
        BigDecimal("92233720368547758071.2")
      ) :: Nil
    )
  }
  ...
  test("Applying schemas") {
    ...
    val schema = StructType(
      StructField(
        ...
        DecimalType.SYSTEM_DEFAULT,
        true
      ) :: StructField("boolean", BooleanType, true) :: StructField(
        "double",
        DoubleType,
        true
      ) :: StructField("integer", IntegerType, true) :: StructField(
        "long",
        LongType,
        true
      ) :: StructField("null", StringType, true) :: StructField(
        "string",
        StringType,
        true
      ) :: Nil
