  ...
  Seq(
    ...
    test(s"project the partitioning column $table") {
      checkAnswer(
        ...
        Row(1, 10) :: Row(2, 10) :: Row(3, 10) :: Row(4, 10) :: Row(
          5,
          10
        ) :: Row(6, 10) :: Row(7, 10) :: Row(8, 10) :: Row(9, 10) :: Row(
          10,
          10
        ) :: Nil
      )
    ...
    test(s"project partitioning and non-partitioning columns $table") {
      checkAnswer(
        ...
        Row("part-1", 1, 10) :: Row("part-2", 2, 10) :: Row(
          "part-3",
          3,
          10
        ) :: Row("part-4", 4, 10) :: Row("part-5", 5, 10) :: Row(
          "part-6",
          6,
          10
        ) :: Row("part-7", 7, 10) :: Row("part-8", 8, 10) :: Row(
          "part-9",
          9,
          10
