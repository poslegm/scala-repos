...
abstract class AggregationQuerySuite
  ...
  override def beforeAll(): Unit = {
    ...
    val emptyDF = sqlContext.createDataFrame(
      ...
      StructType(
        StructField("key", StringType) :: StructField("value", IntegerType) :: Nil
      )
    )
  ...
  test("only do grouping") {
    ...
    checkAnswer(
      ...
      Row(10, 1) :: Row(-60, null) :: Row(30, 1) :: Row(1, 2) :: Row(-10, null) :: Row(
        -1,
        2
      ) :: Row(null, 2) :: Row(100, null) :: Row(null, 3) :: Row(null, null) :: Nil
    )
    ...
    checkAnswer(
      ...
      Row(Seq[Integer](1, 1)) :: Row(Seq[Integer](null)) :: Row(Seq[Integer](1)) :: Row(
        Seq[Integer](2)
      ) :: Row(null) :: Row(Seq[Integer](2, 3)) :: Row(Seq[Integer](2, 3, 4)) :: Row(
        Seq[Integer](3)
      ) :: Nil
    )
    ...
    checkAnswer(
      ...
      Row(10, Seq[Integer](1, 1)) :: Row(-60, Seq[Integer](null)) :: Row(
        30,
        Seq[Integer](1, 1)
      ) :: Row(30, Seq[Integer](1)) :: Row(1, Seq[Integer](2)) :: Row(-10, null) :: Row(
        -1,
        Seq[Integer](2, 3)
      ) :: Row(1, Seq[Integer](2, 3)) :: Row(null, Seq[Integer](2, 3, 4)) :: Row(
        100,
        Seq[Integer](null)
  ...
  test("single distinct column set") {
    ...
    checkAnswer(
      ...
      Row(120.0, 70.0 / 3.0, -10.0 / 3.0, 1, 67.0 / 3.0 + 100.0, 12.0, 20.0) :: Row(
        ...
        10.0,
        2.0
      ) :: Row(null, null, 3.0, 3, null, null, null) :: Row(
        110.0,
        10.0,
        20.0,
        null,
  ...
  test("test count") {
    checkAnswer(
      ...
      Row(1, 10, 1, 1, 1) :: Row(1, -60, 1, 1, null) :: Row(2, 30, 2, 2, 1) :: Row(
        ...
        2,
        2
      ) :: Row(1, -10, 1, 1, null) :: Row(0, -1, 1, 1, 2) :: Row(
        1,
        null,
        1,
        1,
        2
      ) :: Row(1, 100, 1, 1, null) :: Row(1, null, 2, 2, 3) :: Row(
        0,
        null,
        1,
        1,
