  ...
  test("only do grouping") {
    ...
    checkAnswer(
      ...
      Row(10, 1) :: Row(-60, null) :: Row(30, 1) :: Row(1, 2) :: Row(
        -10,
        null
      ) :: Row(-1, 2) :: Row(null, 2) :: Row(100, null) :: Row(null, 3) :: Row(
        null,
        null
      ) :: Nil
    )
    ...
    checkAnswer(
      ...
      Row(Seq[Integer](1, 1)) :: Row(Seq[Integer](null)) :: Row(
        Seq[Integer](1)
      ) :: Row(Seq[Integer](2)) :: Row(null) :: Row(Seq[Integer](2, 3)) :: Row(
        Seq[Integer](2, 3, 4)
    ...
    checkAnswer(
      ...
      Row(10, Seq[Integer](1, 1)) :: Row(-60, Seq[Integer](null)) :: Row(
        30,
        Seq[Integer](1, 1)
      ) :: Row(30, Seq[Integer](1)) :: Row(1, Seq[Integer](2)) :: Row(
        -10,
        null
      ) :: Row(-1, Seq[Integer](2, 3)) :: Row(1, Seq[Integer](2, 3)) :: Row(
        null,
        Seq[Integer](2, 3, 4)
      ) :: Row(100, Seq[Integer](null)) :: Row(null, Seq[Integer](3)) :: Row(
        null,
        null
      ) :: Nil
    )
  ...
  test("single distinct column set") {
    ...
    checkAnswer(
      ...
      Row(
        ...
        12.0,
        20.0
      ) :: Row(100.0, 1.0 / 3.0, 1.0, 2, -2.0 / 3.0 + 100.0, 10.0, 2.0) :: Row(
        null,
        null,
        3.0,
        3,
    ...
    checkAnswer(
      ...
      Row(1, 120.0, -10.0, 40.0, 120.0, 70.0 / 3.0 + 100.0) :: Row(
        ...
        100.0,
        1.0 / 3.0 + 100.0
      ) :: Row(3, null, 3.0, null, null, null) :: Row(
        null,
        110.0,
        60.0,
        30.0,
  ...
  test("test count") {
    checkAnswer(
      ...
      Row(1, 10, 1, 1, 1) :: Row(1, -60, 1, 1, null) :: Row(
        ...
        2,
        1
      ) :: Row(2, 1, 2, 2, 2) :: Row(1, -10, 1, 1, null) :: Row(
        0,
        -1,
        1,
        1,
        2
      ) :: Row(1, null, 1, 1, 2) :: Row(1, 100, 1, 1, null) :: Row(
        1,
        null,
        2,
        2,
  ...
  test("pearson correlation") {
    ...
    checkAnswer(
      ...
      Row(1, null) :: Row(2, null) :: Row(3, Double.NaN) :: Row(
        4,
        Double.NaN
      ) :: Row(5, Double.NaN) :: Row(6, Double.NaN) :: Nil
    )
