...
class DateTimeUtilsSuite extends SparkFunSuite {
  ...
  test("us and julian day") {
    ...
    Seq(
      ...
      Timestamp.valueOf("1900-06-11 20:10:10.100")
    ).foreach { t =>
  ...
  test("string to date") {
    ...
    assert(
      stringToDate(
        UTF8String.fromString("2015-03-18 123142")
      ).get === millisToDays(c.getTimeInMillis)
    )
    assert(
      stringToDate(
        UTF8String.fromString("2015-03-18T123123")
      ).get === millisToDays(c.getTimeInMillis)
    )
    assert(
  ...
  test("string to timestamp") {
    ...
    assert(
      stringToTimestamp(
        UTF8String.fromString("1969-12-31 16:00:00")
    ...
    assert(
      stringToTimestamp(
        UTF8String.fromString("2015-03-18")
      ).get === c.getTimeInMillis * 1000
    )
    assert(
      stringToTimestamp(
    ...
    assert(
      stringToTimestamp(
        UTF8String.fromString("2015-03-18T")
      ).get === c.getTimeInMillis * 1000
    )
    ...
    assert(
      stringToTimestamp(
        UTF8String.fromString("2015-03-18 12:03:17")
      ).get === c.getTimeInMillis * 1000
    )
    assert(
      stringToTimestamp(
        UTF8String.fromString("2015-03-18T12:03:17")
      ).get === c.getTimeInMillis * 1000
    )
    ...
    assert(
      stringToTimestamp(
        UTF8String.fromString("2015-03-18T12:03:17-13:53")
      ).get === c.getTimeInMillis * 1000
    )
    ...
    assert(
      stringToTimestamp(
        UTF8String.fromString("2015-03-18T12:03:17Z")
      ).get === c.getTimeInMillis * 1000
    )
    assert(
      stringToTimestamp(
        UTF8String.fromString("2015-03-18 12:03:17Z")
      ).get === c.getTimeInMillis * 1000
    )
    ...
    assert(
      stringToTimestamp(
        UTF8String.fromString("2015-03-18T12:03:17-1:0")
      ).get === c.getTimeInMillis * 1000
    )
    assert(
      stringToTimestamp(
        UTF8String.fromString("2015-03-18T12:03:17-01:00")
      ).get === c.getTimeInMillis * 1000
    )
    ...
    assert(
      stringToTimestamp(
        UTF8String.fromString("2015-03-18T12:03:17+07:30")
      ).get === c.getTimeInMillis * 1000
    )
    ...
    assert(
      stringToTimestamp(
        UTF8String.fromString("2015-03-18T12:03:17+07:03")
      ).get === c.getTimeInMillis * 1000
    )
    ...
    assert(
      stringToTimestamp(
        UTF8String.fromString("2015-03-18 12:03:17.123")
      ).get === c.getTimeInMillis * 1000
    )
    assert(
      stringToTimestamp(
        UTF8String.fromString("2015-03-18T12:03:17.123")
      ).get === c.getTimeInMillis * 1000
    )
    ...
    assert(
      stringToTimestamp(
        UTF8String.fromString("2015-03-18T12:03:17.456Z")
      ).get === c.getTimeInMillis * 1000
    )
    assert(
      stringToTimestamp(
        UTF8String.fromString("2015-03-18 12:03:17.456Z")
      ).get === c.getTimeInMillis * 1000
    )
    ...
    assert(
      stringToTimestamp(
        UTF8String.fromString("2015-03-18T12:03:17.123-1:0")
      ).get === c.getTimeInMillis * 1000
    )
    assert(
      stringToTimestamp(
        UTF8String.fromString("2015-03-18T12:03:17.123-01:00")
      ).get === c.getTimeInMillis * 1000
    )
    ...
    assert(
      stringToTimestamp(
        UTF8String.fromString("2015-03-18T12:03:17.123+07:30")
      ).get === c.getTimeInMillis * 1000
    )
    ...
    assert(
      stringToTimestamp(
        UTF8String.fromString("2015-03-18T12:03:17.123121+7:30")
      ).get === c.getTimeInMillis * 1000 +
        121
    )
    ...
    assert(
      stringToTimestamp(
        UTF8String.fromString("2015-03-18T12:03:17.12312+7:30")
      ).get === c.getTimeInMillis * 1000 +
        120
    )
    ...
    assert(
      stringToTimestamp(
        UTF8String.fromString("18:12:15")
      ).get === c.getTimeInMillis * 1000
    )
    ...
    assert(
      stringToTimestamp(
        UTF8String.fromString("T18:12:15.12312+7:30")
      ).get === c.getTimeInMillis * 1000 +
        120
    )
    ...
    assert(
      stringToTimestamp(
        UTF8String.fromString("18:12:15.12312+7:30")
      ).get === c.getTimeInMillis * 1000 +
        120
    )
    ...
    assert(
      stringToTimestamp(
        UTF8String.fromString("2011-05-06 07:08:09.1000")
      ).get === c.getTimeInMillis * 1000
    )
    ...
    assert(
      stringToTimestamp(
        UTF8String.fromString("2015-03-18T12:03.17-20:0")
      ).isEmpty
    )
    assert(
      stringToTimestamp(
        UTF8String.fromString("2015-03-18T12:03.17-0:70")
      ).isEmpty
    )
    assert(
      stringToTimestamp(
        UTF8String.fromString("2015-03-18T12:03.17-1:0:0")
      ).isEmpty
    )
    ...
    assert(
      stringToTimestamp(
        UTF8String.fromString("2015-03-18T12:03:17.123456789+0:00")
      ).get === c.getTimeInMillis * 1000 +
        123456
    )
  }
  ...
  test("to UTC timestamp") {
    def test(utc: String, tz: String, expected: String): Unit = {
      assert(
        toJavaTimestamp(
          toUTCTime(fromJavaTimestamp(Timestamp.valueOf(utc)), tz)
        ).toString === expected
      )
    }
    test("2011-12-25 09:00:00.123456", "UTC", "2011-12-25 09:00:00.123456")
