...
class EncoderErrorMessageSuite extends SparkFunSuite {
  ...
  test("nice error message for missing encoder") {
    val errorMsg1 = intercept[UnsupportedOperationException](
      ExpressionEncoder[ComplexNonEncodable1]
    ).getMessage
    assert(
    ...
    val errorMsg2 = intercept[UnsupportedOperationException](
      ExpressionEncoder[ComplexNonEncodable2]
    ).getMessage
    assert(
    ...
    val errorMsg3 = intercept[UnsupportedOperationException](
      ExpressionEncoder[ComplexNonEncodable3]
    ).getMessage
    assert(
    ...
    val errorMsg4 = intercept[UnsupportedOperationException](
      ExpressionEncoder[ComplexNonEncodable4]
    ).getMessage
    assert(
    ...
    val errorMsg5 = intercept[UnsupportedOperationException](
      ExpressionEncoder[ComplexNonEncodable5]
    ).getMessage
    assert(
