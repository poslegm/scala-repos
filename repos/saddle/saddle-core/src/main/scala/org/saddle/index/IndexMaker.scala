...
object IndexMaker extends IndexMakerLowPriority {
  ...
  implicit def make4V[T[K] <: SeqLike[
    K
  ], I1: ST: ORD, I2: ST: ORD, I3: ST: ORD, I4: ST: ORD] =
  ...
  implicit def make5V[T[K] <: SeqLike[
    K
  ], I1: ST: ORD, I2: ST: ORD, I3: ST: ORD, I4: ST: ORD, I5: ST: ORD] =
  ...
  private def zip4V[T[K] <: SeqLike[
    K
  ], A: ST: ORD, B: ST: ORD, C: ST: ORD, D: ST: ORD](
      a: T[A],
      b: T[B],
      c: T[C],
      d: T[D]
